(function($){
	...
	$(".widget-toggle-btn").on("click", function() {
		...
		$(this).next(".toggle-widget").slideToggle();
		return false;
	});
	...
	$(".toggle-section-btn").on("click", function() {
		$(this).toggleClass("active");
		$(this).closest(".section-title").next(".toggle-section").slideToggle();
		return false;
	});
		...
		$(".has-dropdown .click").each(function() {
			...
			$this.on("click", function() {
				if ( $this.next().is(".dropdown-holder") ) {
					...
					$this.next(".dropdown-holder").slideToggle(250);
				}
				return false;
			});
		});
	...
	function leftSideNav() {
		$(".toggle-side-nav").each(function() {
			...
			if ( window_width > 1366 ) {
				...
				$(this).closest(".side-nav-wrap").addClass("opened");
			}

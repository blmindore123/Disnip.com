...
class Login_model extends CI_Model {
	...
	function search_record($table,$coloum,$coloum_value){
		$this->db->select('*');
    	$this->db->from($table);
		$this->db->like($coloum,$coloum_value);
...
//***************************************************************//    
    ...
    function count_records($table)
    {
	 ...
	 function get_data_where_condition($table,$where,$limit="",$orderby="")//fatch all data with where condition
	{
		$this->db->select('*');
		$this->db->from($table);
		$this->db->where($where);
...
//***********************End Insert Data******************************//
	...
	function get_join_three_table_where($table1,$table2,$table3,$id1,$id2,$id3,$id4,$where = '',$column='',$orderby=''){
		if($column !='')
                {
                    $this->db->select($column);
                }
    ...
    function get_record_join_two_table_groupby($table1,$table2,$id1,$id2,$column='',$where='', $groupby = '',$orderby=''){
        if($column !='')
        {
            $this->db->select($column);
        }
	...
	function get_record_leftjoin_two_table($table1,$table2,$id1,$id2,$column='',$where=''){
        ...
        if($where !='')
        {
            ...
            $this->db->group_by('user_mobile_no');

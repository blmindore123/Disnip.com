			...
			<footer class="main-footer sticky footer-type-1">
				...
				<div class="footer-inner">
					...
					<div class="footer-text">
						&copy; 2017
						<strong>Disnip Store Management</strong> 
					</div>
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/js/datatables/dataTables.bootstrap.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/printsheet.css" media="print">
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/js/wysihtml5/src/bootstrap-wysihtml5.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/js/uikit/vendor/codemirror/codemirror.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/js/uikit/uikit.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/js/uikit/css/addons/uikit.almost-flat.addons.min.css">
	...
	<script src="<?php echo base_url(); ?>assets/js/xenon-custom.js"></script>
        ...
        <script src="<?php echo base_url(); ?>assets/js/wysihtml5/src/bootstrap-wysihtml5.js"></script>
	<script src="<?php echo base_url(); ?>assets/js/uikit/vendor/codemirror/codemirror.js"></script>
	<script src="<?php echo base_url(); ?>assets/js/uikit/vendor/marked.js"></script>
	<script src="<?php echo base_url(); ?>assets/js/uikit/js/uikit.min.js"></script>
	<script src="<?php echo base_url(); ?>assets/js/uikit/js/addons/htmleditor.min.js"></script>
    ...
    <script src="<?php echo base_url(); ?>assets/js/datepicker/jquery_access.js"></script>
	<script src="<?php echo base_url(); ?>assets/js/datepicker/jquery.addon.js"></script>

                ...
                if (!empty($terms_conditions)) {
                    ...
                    foreach ($terms_conditions as $value) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $value->terms_conditions_content; ?></td>
                            <td style="width: 25%">

        <?php $status = $value->terms_conditions_status; ?>

                                <a href="<?php echo site_url('admin/edit_terms_conditions') . '/' . $value->terms_conditions_id; ?>" class="" ><i class="fa-pencil icon-blue"></i>
                                    &nbsp;
                                    <!-- <?php if ($status == 1) { ?>

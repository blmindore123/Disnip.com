...
//echo "INSERT INTO payment(payment_deliver_id,payment_user_id,payment_amount,payment_transaction_id,payment_type,payment_date,payment_status) VALUES('".$deliver_id."','".$user_id."','".$main_total."','".$txn_id."','3','".$orderdate."','1')";
    $insert = mysql_query("INSERT INTO payment(payment_deliver_id,payment_user_id,payment_amount,payment_transaction_id,payment_type,payment_date,payment_status) VALUES('".$deliver_id."','".$user_id."','".$main_total."','".$txn_id."','3','".$orderdate."','3')");
